...
class Climber extends Applet {
	...
	void updateLeftArmDrawingPoints() {
		...
		lateralProximalLeftHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftShoulderSocketPos, upperArmWidth, leftHumerusOrientation, false);
		medialProximalLeftHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftShoulderSocketPos, upperArmWidth, leftHumerusOrientation, true);
		lateralDistalLeftHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftElbowPos, elbowWidth, leftHumerusOrientation, false);
		medialDistalLeftHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftElbowPos, elbowWidth, leftHumerusOrientation, true);
		
		lateralProximalLeftForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftElbowPos, elbowWidth, leftForearmOrientation, false);
		medialProximalLeftForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftElbowPos, elbowWidth, leftForearmOrientation, true);
		lateralDistalLeftForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftWristPos, wristWidth, leftForearmOrientation, false);
		medialDistalLeftForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftWristPos, wristWidth, leftForearmOrientation, true);	
	}
	...
	void updateRightArmDrawingPoints() {
		...
		lateralProximalRightHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightShoulderSocketPos, upperArmWidth, rightHumerusOrientation, true);
		medialProximalRightHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightShoulderSocketPos, upperArmWidth, rightHumerusOrientation, false);
		lateralDistalRightHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightElbowPos, elbowWidth, rightHumerusOrientation, true);
		medialDistalRightHumerus = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightElbowPos, elbowWidth, rightHumerusOrientation, false);
		
		lateralProximalRightForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightElbowPos, elbowWidth, rightForearmOrientation, true);
		medialProximalRightForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightElbowPos, elbowWidth, rightForearmOrientation, false);
		lateralDistalRightForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightWristPos, wristWidth, rightForearmOrientation, true);
		medialDistalRightForearm = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightWristPos, wristWidth, rightForearmOrientation, false);
	}
	...
	void updateLeftLegDrawingPoints() {
		...
		lateralProximalLeftThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftHipSocketPos, upperThighWidth, leftThighOrientation, false);
		medialProximalLeftThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftHipSocketPos, upperThighWidth, leftThighOrientation, true);
		lateralDistalLeftThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftKneePos, kneeWidth, leftThighOrientation, false);
		medialDistalLeftThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftKneePos, kneeWidth, leftThighOrientation, true);
		
		lateralProximalLeftCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftKneePos, kneeWidth, leftCalfOrientation, false);
		medialProximalLeftCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftKneePos, kneeWidth, leftCalfOrientation, true);
		lateralDistalLeftCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftAnklePos, ankleWidth, leftCalfOrientation, false);
		medialDistalLeftCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(leftAnklePos, ankleWidth, leftCalfOrientation, true);
	...
	void updateRightLegDrawingPoints() {
		...
		lateralProximalRightThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightHipSocketPos, upperThighWidth, rightThighOrientation, true);
		medialProximalRightThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightHipSocketPos, upperThighWidth, rightThighOrientation, false);
		lateralDistalRightThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightKneePos, kneeWidth, rightThighOrientation, true);
		medialDistalRightThigh = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightKneePos, kneeWidth, rightThighOrientation, false);
		
		lateralProximalRightCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightKneePos, kneeWidth, rightCalfOrientation, true);
		medialProximalRightCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightKneePos, kneeWidth, rightCalfOrientation, false);
		lateralDistalRightCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightAnklePos, ankleWidth, rightCalfOrientation, true);
		medialDistalRightCalf = findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(rightAnklePos, ankleWidth, rightCalfOrientation, false);
	...
	Point findACornerPointForABodySegmentByShiftingAMidlinePointInADirectionPerpendicularToTheOrientationOfTheBodySegment(Point startingPoint, float bodySegmentWidth, float bodySegmentOrientation, boolean counterclockwise) {
